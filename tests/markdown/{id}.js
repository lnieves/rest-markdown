...
/**
 * Test for /markdown/{id}
 */
Test('/markdown/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getMarkdown get operation', function (t) {
            Mockgen().requests({
                path: '/markdown/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                server.inject(options, function (res) {
                    ...
                    var validate = Validator(api.paths['/markdown/{id}']['get']['responses']['200']['schema']);
